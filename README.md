...
3. [Setup Instructions](#setup-instructions)
   ...
   - [Setting up the API Environment](#setting-up-the-api-environment)
   - [Setting up the Environments Using conda](#setting-up-the-environments-using-conda)
...
4. [Development Workflow](#development-workflow)
   - [Working on the Model](#working-on-the-model)
   - [Working on the API](#working-on-the-api)
5. [Running Tests with Coverage](#running-tests-with-coverage)
6. [Deployment](#deployment)
   - [Setting Up Azure Resources](#setting-up-azure-resources)
   - [Setting Up Deployment Credentials](#setting-up-deployment-credentials)
   - [Deploying the Model to Azure ML](#deploying-the-model-to-azure-ml)
   - [Deploying the API to Azure Functions](#deploying-the-api-to-azure-functions)
7. [Blue-Green Deployment Process](#blue-green-deployment-process)
8. [Scaling and Stress Testing](#scaling-and-stress-testing)
